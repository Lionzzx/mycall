...
<template>
	<view class="tabbarMain" :class="[flagTypeInfo ? 'tabbarMainIphone' : '']">
		...
		<view class="tabBtnMina" :class="[flagTypeInfo ? 'tabBtnMinaIphone' : '']" mode="">
			...
			<view class="itmMain" @click.stop="switchTabFunc(1, '/pages/call/call')">
				...
				<text class="txtBtn" :class="{ txtBtnSel: active == 1 }">打卡</text>
			</view>
			<view class="itmMain">
			...
			<view class="itmMain" @click.stop="switchTabFunc(3, '/pages/idea/idea')">
				...
				<text class="txtBtn" :class="{ txtBtnSel: active == 3 }">想法</text>
			</view>
			<view class="itmMain" @click.stop="switchTabFunc(4, '/pages/mine/mine')">
